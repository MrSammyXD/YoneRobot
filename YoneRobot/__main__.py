...
buttons = [
    [
        InlineKeyboardButton(
            text="🔸 ADD ME TO YOUR GROUP 🔸", url="t.me/QueenJNC_Bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="🔸 ADD JNC MUSIC TO YOUR GROUP🔸", url="https://t.me/QueenJncMusicBot?startgroup=true"),
    ],
]
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text="""  I'm *JNC ❤️*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_JNC's licensed under the GNU General Public License v3.0_           
                 \n\nIf you have any question about yone, let us know at [JNC SUPPORT 🤍](https://t.me/jnc_support) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
